        ...
        <div className="item-content">
            <div className="item-infos">
                ...
                <div className="col-2 leading-5">
                    ...
                    {elem.googleId && <div className="text-gray-600 text-sm">Google ID : {elem.googleId}</div>}
                    {elem.facebookId && <div className="text-gray-600 text-sm">Facebook ID : {elem.facebookId}</div>}
                </div>
                <div className="col-3">
