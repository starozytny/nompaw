...
export function ButtonIcon ({ type, icon, onClick, children, tooltipWidth, tooltipPosition, customBtn = "" }) {
	const colorVariants = {
		...
		transparent: 'bg-transparent shadow-sm text-gray-900 hover:bg-gray-50 ring-0 ring-inset ring-transparent',
		none: ''
	}
	...
	return <button onClick={onClick}
		...
		{children
			? <span className={`tooltip bg-gray-800 text-slate-50 py-1 px-2 rounded absolute ${tooltipPos} text-xs hidden whitespace-nowrap`}
					style={divStyle}>
				{children}
		</span>
			: null
